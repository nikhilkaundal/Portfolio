...
export const DIC_EXP = {
  ...
  tagline:
    "Built a production RAG-based AI chatbot from scratch, covering scraping, indexing, LLM integration, and full-stack deployment, reducing admission query resolution time by ~60%.",
  ...
  highlights: [
    ...
    "Engineered an intent-to-link mapping system ensuring every response includes exactly one verified official PU hyperlink, eliminating duplicate/irrelevant link confusion entirely",
