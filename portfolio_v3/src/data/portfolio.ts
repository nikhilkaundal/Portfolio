...
export const PROJECTS: ProjectData[] = [
  {
    ...
    subtitle: "Full-Stack Real-Time Food Delivery & Management Platform",
    desc: "Engineered an enterprise-grade food ordering and cafe management application using Next.js 16 (App Router), TypeScript, Tailwind CSS, and Supabase (PostgreSQL & Auth). Features interactive GPS pin detection with OpenStreetMap/Leaflet, 12km geofence zone validation, multi-address management, real-time order tracking, and 3-role RBAC for Customers, Staff, and Cafe Owners.",
    metrics: [
      { val: "12km", label: "GPS Geofence Zone" },
      { val: "Next.js 16", label: "App Router & React 19" },
      { val: "3 Roles", label: "RBAC (Supabase RLS)" },
      { val: "100%", label: "Real-time Sync" }
    ],
    coreStack: ["NEXT.JS 16", "TYPESCRIPT", "TAILWIND CSS", "SUPABASE"],
    tools: ["LEAFLET", "OPENSTREETMAP", "FRAMER MOTION", "POSTGRESQL", "VERCEL"],
    badge: "live",
    urlBarText: "https://celebration-cafe.vercel.app",
    mediaType: "image",
    mediaSrc: "/proof/Cafe1.png",
    liveUrl: "https://celebration-cafe.vercel.app/",
    githubUrl: "https://github.com/nikhilkaundal/celebration-cafe",
